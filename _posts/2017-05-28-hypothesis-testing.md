...
$$ f(p) = f\left(\frac{1}{2}\right) + f'left(\frac{1}{2}\right)(p-1/2) + \frac{1}{2}f''(\xi)(p-1/2)^2,$$

where $$\xi \in [0,1/2]$$. 

Then we have

$$\int f(p_R-p_B) dF((p_R,p_B) \rvert M_R,M_B) = f\left(\frac{1}{2}\right) +  f'\left(\frac{1}{2}\right) \left(\mathbb{E}(p_R \rvert D_R ) - \mathbb{E}(p_B \rvert D_B )\right) + \frac{1}{2} f''(\xi)\left(\textrm{Var}(p_R \rvert M_R)+\textrm{Var}(p_B \rvert M_B)\right)$$,
