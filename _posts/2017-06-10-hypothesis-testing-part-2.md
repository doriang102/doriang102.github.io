...
$$ \Phi_{n,m}(x) \leq \frac{\max_p f \sqrt{\frac{x^{2n+1}}{2n+1}}\sqrt{\frac{x^{2m+1}}{2m+1}}}{\frac{\min_p f}{n+1} \left(\frac{m}{m+n}\right)^{n+1}\left(1 - \frac{m}{m+n}\right)^{m}} = \frac{ \max_p f}{\min_p f} \frac{n+1}{\sqrt{2m+1}\sqrt{2n+1}} \frac{x^{n+1/2}(1-x)^{m+1/2}}{\left(\frac{m}{m+n}\right)^{n+1}\left(1 - \frac{m}{m+n}\right)^{m}} $$
