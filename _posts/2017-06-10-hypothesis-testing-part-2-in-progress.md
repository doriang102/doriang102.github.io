...
$$\frac{p(D \lvert H_1)}{p(D \lvert H_2)} = e^{\frac{-N c_{\beta} \epsilon^2}{\sigma_{\beta^2}}},$$

_where_  $$\sigma_{\beta} = \beta (1- \beta) $$ and $$c_{\beta}$$ is a constant depending on $$\beta$$ satisfying

$$ \frac{1}{4} \leq c_{\beta} \leq 1.$$
